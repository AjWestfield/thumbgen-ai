        ...
        <ClerkProvider
          appearance={{
            ...
            elements: {
              ...
              // UserButton popover dropdown - all dark black
              userButtonPopoverCard: "bg-zinc-950 border border-zinc-800",
              userButtonPopoverMain: "bg-zinc-950",
              userButtonPopoverActions: "bg-zinc-950",
              userButtonPopoverActionButton: "bg-zinc-950 text-zinc-300 hover:bg-zinc-800",
              userButtonPopoverActionButtonText: "text-zinc-300",
              userButtonPopoverActionButtonIcon: "text-zinc-400",
              userButtonPopoverFooter: "bg-zinc-950 border-zinc-800 hidden",
              userPreviewMainIdentifier: "text-white",
              userPreviewSecondaryIdentifier: "text-zinc-400",
              // User preview section in popover
              userButtonBox: "bg-zinc-950",
              userPreview: "bg-zinc-950",
              userPreviewAvatarBox: "bg-zinc-950",
              userPreviewTextContainer: "bg-zinc-950",
